...
It's 2020 and starting a new project has never been easier. There are "batteries included" tools that solve many different categories of problems. Our job as developers is to stand on top the shoulders of the IaaS, PaaS, SaaS, and Docker/K8 giants and build things. Yet ironically, developers sit down today, with the power of decades of innovation awaiting their GUI-issued commands, and have a hard time starting their one job—to build things.
